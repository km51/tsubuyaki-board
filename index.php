...
<div id="wrap">
  ...
  <div id="content">
    ...
    <form action="" method="post">
      <dl>
        <dt><?php print(htmlspecialchars($member['name'], ENT_QUOTES)); ?>さんは何をつぶやく？</dt>
        <dd>
...
<?php foreach ($posts as $post): ?>
    <div class="msg">
      <img class="member_picture" src="member_picture/<?php print(htmlspecialchars($post['picture'], ENT_QUOTES)); ?>" width="48" height="48" alt="<?php print(htmlspecialchars($post['name'], ENT_QUOTES)); ?>" />
